...
describe('Project Contract', () => {
    ...
    it('allows investor to approve payments', async () => {
        ...
        // 投资项目
        await project.methods.contribute().send({ from: investor, value: '5000', });

        // 资金支出请求
        await project.methods.createPayment('Rent Office', 2000, receiver).send({ from: owner, gas: '1000000', });

        // 投票
        await project.methods.approvePayment(0).send({ from: investor, gas: '1000000', });

        // 资金划转
        await project.methods.doPayment(0).send({ from: owner, gas: '1000000', });
